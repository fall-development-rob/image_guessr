...
- Removed the python code into a seperate repo (https://github.com/fall-development-rob/genguessr_api), to abide by seperation of concern and to keep it more manageable. 
